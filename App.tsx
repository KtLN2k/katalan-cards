  ...
  const fetchUserData = async () => {
    try {
      ...
      if (userData && userData._id) {
        ...
        console.log(
          "User data extracted from token and stored in Redux:",
          userData,
        );
        return userData;
      }
      ...
      try {
        ...
        console.log(
          "User data fetched from API and stored in Redux:",
          response.data,
        );
        return response.data;
      } catch (apiError) {
        console.warn(
          "Could not fetch user data from API, using token data instead",
        );
        if (userData) {
          dispatch(userActions.login(userData));
          return userData;
        ...
        >
          ...
          <Navbar.Collapse className="ml-20 flex-grow">
            ...
            <Navbar.Link
              ...
              to="/about"
              href="#"
              className="font-medium hover:text-purple-800 dark:hover:text-purple-300"
            >
              About
            </Navbar.Link>
          </Navbar.Collapse>
            ...
            {!isLoggedIn ? (
              <>
                <Button
                  ...
                  className="font-medium shadow-sm transition duration-200 hover:shadow"
                >
                  Signup
                </Button>
                <Button
              ...
              <>
                ...
                <Button
                  ...
                  outline
                  onClick={logout}
                  className="border-gray-300 font-medium transition duration-200 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700"
                >
                  Logout
                </Button>
              </>
          ...
          <Navbar.Collapse className="ml-4">
            {/* Search Bar */}
            <div className="mx-4 flex max-w-sm flex-grow">
